...
public class RelativeLayoutRipple extends RelativeLayout {
    ...
    public RelativeLayoutRipple(final Context context) {
        super(context);
        init();
    }

    public RelativeLayoutRipple(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RelativeLayoutRipple(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.newstand_check_color));

        mRectPaint = new Paint();
        mRectPaint.setColor(Color.argb(0, 84, 110, 122));
//        mRectPaint.setColor(getResources().getColor(R.color.transparent));
