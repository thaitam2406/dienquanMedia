...
public class TextViewRipple extends TextView {
    ...
    public TextViewRipple(final Context context) {
        super(context);
        init();

    }

    public TextViewRipple(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewRipple(final Context context, final AttributeSet attrs, final int defStyle) {
