...
public class ImageRipple extends ImageViewOptimize {
    ...
    public ImageRipple(final Context context) {
        super(context);
        init();
    }

    public ImageRipple(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ImageRipple(final Context context, final AttributeSet attrs, final int defStyle) {
